...
public class ViewMain{
    ...
    private final ObservableList<Member> data =
            ...
            new Member("Alaa Elwan", "1", "alaaElwan@gmail.com"),
            new Member("Amr Mahmoud", "2", "AmrMahmoud@gmail.com"));
    ...
    public void View(Stage stage) {
        ...
        firstNameCol.setCellValueFactory(
            new PropertyValueFactory<Member, String>("MemberName"));
        ...
        lastNameCol.setCellValueFactory(
            new PropertyValueFactory<Member, String>("MemberID"));
